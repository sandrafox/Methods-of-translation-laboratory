...
public class AbLexer {
    ...
    private List<Map.Entry<String, String>> terminals = Arrays.asList(new AbstractMap.SimpleEntry<String, String>("C", "abc"),new AbstractMap.SimpleEntry<String, String>("C", "cda"),new AbstractMap.SimpleEntry<String, String>("D", "\\+\\+"));
    private List<Map.Entry<String, Pattern>> regexp = new ArrayList<>();
    public AbLexer(String input) {
        this.input = input;
